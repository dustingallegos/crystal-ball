...
(function () {
    ...
    app.get('/api/constituentSearch/:searchText', routes.auth.checkSession, routes.api.getConstituentSearch);
    ...
    function onListen() {
        console.log('Crystal Ball app running for https://localhost:%s/', process.env.PORT);
    }
